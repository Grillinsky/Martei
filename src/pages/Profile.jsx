  ...
  return (
    <>
     ...
     <div className="edit-inputs-profile">
        <input required="required" id="inputField" placeholder="Name..." type="text"></input>
        <label class="usernameLabel" for="inputField"> Name:</label>
    ...
    <div className="edit-input-profile">
        <input required="required" id="inputField" placeholder="Username..." type="text"></input>
        <label class="usernameLabel" for="inputField"> Username:</label>
        <svg viewBox="0 0 448 512" class="userIcon"><path d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512H418.3c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304H178.3z"></path></svg>
    </div>
        <button class="btn-input-profile">
            Edit Name
        </button>
        <button class="btn-input-profile-two">
            Edit Username
        </button>
           </div>
        </div>
