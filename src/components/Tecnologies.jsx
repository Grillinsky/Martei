    ...
    <div id="tecnologiesContainer" className="mt-0">
      <div className="card-tecnology mb-5 mt-0 ">
        ...
        <a className="social-link-5 m-2">
          ...
          >
            <title />
            <g data-name="MySQL Logo" id="MySQL_Logo">
              <g data-name="<Group>" id="_Group_">
                <path
                  d="M23.5,23.5c-.91-1.29-3.56-2.25-4-4,1.5-.25,4-1,4-1a14.86,14.86,0,0,0-6-4C16.19,12.06,13.72,3,4.5,2,4.5,2,2.31.5,1.5.5s-1,.25-1,1,2,2.75,2,3.5a10,10,0,0,0,2,4.5,7.48,7.48,0,0,0-1,4c0,2.22,1,3.5,2,3.5s1-3.5,1-3.5,1.34,4.13,4,6"
                  data-name="<Path>"
                  id="_Path_"
                  style={{
                    fill: "none",
        ...
        <a className="social-link-6 m-2">
          ...
          >
            ...
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M0.698 0A0.698 0.698 0 0 0 0 0.698c0 0.308 0.201 0.569 0.475 0.664 0.034 0.004 0.047 -0.017 0.047 -0.034v-0.12c-0.193 0.043 -0.235 -0.094 -0.235 -0.094 -0.03 -0.081 -0.077 -0.103 -0.077 -0.103 -0.064 -0.043 0.004 -0.043 0.004 -0.043 0.069 0.004 0.107 0.073 0.107 0.073 0.064 0.107 0.163 0.077 0.201 0.06 0.004 -0.047 0.026 -0.077 0.043 -0.094 -0.154 -0.017 -0.317 -0.077 -0.317 -0.347 0 -0.077 0.026 -0.137 0.073 -0.188 -0.004 -0.013 -0.03 -0.086 0.009 -0.18 0 0 0.06 -0.017 0.193 0.073 0.056 -0.017 0.116 -0.021 0.176 -0.021s0.12 0.009 0.176 0.021c0.133 -0.09 0.193 -0.073 0.193 -0.073 0.038 0.094 0.013 0.167 0.008 0.184a0.276 0.276 0 0 1 0.073 0.188c0 0.27 -0.163 0.325 -0.317 0.343 0.026 0.021 0.047 0.064 0.047 0.128v0.193c0 0.017 0.013 0.038 0.047 0.034A0.699 0.699 0 0 0 1.4 0.698C1.396 0.313 1.083 0 0.698 0z"
              fill="#000000"
            />
          </svg>
        </a>
