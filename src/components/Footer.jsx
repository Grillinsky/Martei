...
function Footer() {
  return (
    <footer className="container-fluid py-4 fixed-bottom">
        ...
        <div className="col-lg-6">
          <div className="row">
            ...
            <div className="col-4" style={{ marginTop: "5px" }}>
              <dd className="footer-name" style={{ marginLeft: "31px" }}>
                Catálogo
              </dd>
              <ul>
                <li>
            ...
            <div className="col-6 col-md-6 mt-4">
              <ul>
                ...
                <li className="mt-3">
                  ...
                  >
                    <i className="fab fa-whatsapp fs-5 ms-0 mx-1 fw-normal"></i>
                    <span className="ms-2">Chatea con nosotros</span>
                  </a>
                </li>
              </ul>
            </div>
